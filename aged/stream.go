...
func setLastChunkFlag(nonce *[chacha20poly1305.NonceSizeX]byte) {
	nonce[len(nonce)-1] = lastChunkFlag
}

func nonceIsZero(nonce *[chacha20poly1305.NonceSizeX]byte) bool {
	return *nonce == [chacha20poly1305.NonceSizeX]byte{}
}
