...
func TestE2EEHash(t *testing.T) {
	...
	tests := []struct {
		...
		/*{
			...
			data: data,
			//nolint:lll
			expected: []byte{125, 248, 190, 195, 198, 88, 46, 23, 202, 231, 20, 122, 137, 254, 138, 158, 14, 106, 172, 66, 145, 2, 133, 241, 193, 201, 66, 196, 253, 244, 221, 74},
		},*/
		{
			name: "SHA3-384",
			algo: &hasher.Sha3384{},
		...
		/*{
			...
			data: data,
			//nolint:lll
			expected: []byte{70, 76, 240, 176, 170, 132, 66, 114, 0, 4, 2, 25, 1, 212, 60, 136, 129, 94, 235, 237, 3, 222, 156, 115, 188, 226, 122, 125, 102, 237, 58, 52, 49, 146, 251, 236, 161, 199, 222, 119, 11, 190, 37, 195, 177, 225, 229, 221},
		},*/
		{
			name: "SHA3-512",
			algo: &hasher.Sha3512{},
		...
		/*{
			...
			data: data,
			//nolint:lll
			expected: []byte{215, 171, 252, 58, 13, 187, 153, 122, 7, 173, 184, 235, 37, 156, 201, 47, 20, 37, 221, 0, 105, 169, 212, 68, 187, 149, 151, 93, 118, 94, 9, 235, 250, 157, 7, 8, 180, 23, 60, 216, 11, 82, 200, 255, 57, 170, 192, 148, 154, 237, 119, 43, 242, 205, 150, 162, 251, 68, 155, 174, 238, 227, 3, 5},
		},*/
	}
