	...
	testCases := []testStructue{
		{
			...
			encrypt: []cases{
				...
				{
					name:        "repeating sequence error",
					key:         []byte{0x01, 0x02, 0x03, 0x01, 0x02, 0x03},
					payload:     []byte{0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00},
					expectedErr: "insecure xor operation, key is a repeating sequence",
				},
			},
		},
		{
